...
<?php
$_wa_num = get_field( 'contacto_whatsapp', 11 );
$_wa_url = $_wa_num ? 'https://wa.me/' . esc_attr( $_wa_num ) . '?text=' . rawurlencode( 'Hola, quiero recibir asesoría REDIMAG.' ) : '#';
?>
<a class="floating-whatsapp" href="<?php echo esc_url( $_wa_url ); ?>" target="_blank" rel="noopener" aria-label="Consultar por WhatsApp">
